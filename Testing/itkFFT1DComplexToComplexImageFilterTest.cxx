/** 
 * @file itkFFT1DComplexToComplexImageFilterTest.cxx
...
void RegisterTests()
{
  REGISTER_TEST( itkFFT1DComplexToComplexImageFilterTest );
}
...
int itkFFT1DComplexToComplexImageFilterTest( int argc, char* argv[] )
{
  if( argc < 3 )
    {
  ...
  typedef itk::FFT1DComplexToComplexImageFilter< PixelType, Dimension > FFTType;
