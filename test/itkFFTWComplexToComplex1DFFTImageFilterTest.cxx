...
int
itkFFTWComplexToComplex1DFFTImageFilterTest(int argc, char * argv[])
{
  if (argc < 3)
  {
  ...
  using FFTType = itk::FFTWComplexToComplex1DFFTImageFilter<ComplexImageType, ComplexImageType>;
