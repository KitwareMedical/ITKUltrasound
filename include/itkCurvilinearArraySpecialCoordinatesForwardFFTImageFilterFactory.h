...
#ifndef itkCurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory_h
#define itkCurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory_h
...
class CurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory : public itk::ObjectFactoryBase
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(CurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory);

  using Self = CurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory;
  ...
  itkTypeMacro(CurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory, itk::ObjectFactoryBase);

  /** Register one factory of this type  */
  static void
  RegisterOneFactory()
  {
    CurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory::Pointer factory =
      CurvilinearArraySpecialCoordinatesForwardFFTImageFilterFactory::New();
