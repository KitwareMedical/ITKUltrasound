...
MultiResolutionThresholdBoundingBoxSearchRegionImageSource<
  ...
  TMovingImage,
  TMetricImage,
  TDisplacementImage>::MultiResolutionThresholdBoundingBoxSearchRegionImageSource()
...
MultiResolutionThresholdBoundingBoxSearchRegionImageSource<
  ...
  TMovingImage,
  TMetricImage,
  TDisplacementImage>::SetDisplacementImage(DisplacementImageType * image)
{
...
template <class TFixedImage, class TMovingImage, class TMetricImage, class TDisplacementImage>
void
MultiResolutionThresholdBoundingBoxSearchRegionImageSource<TFixedImage,
                                                           TMovingImage,
                                                           TMetricImage,
                                                           TDisplacementImage>::SetThresholdSchedule(const ThresholdType
                                                                                                       threshold)
{
...
MultiResolutionThresholdBoundingBoxSearchRegionImageSource<
  ...
  TMovingImage,
  TMetricImage,
  TDisplacementImage>::SetMetricImagePixel(const PointType & point,
...
MultiResolutionThresholdBoundingBoxSearchRegionImageSource<TFixedImage,
                                                           TMovingImage,
                                                           TMetricImage,
                                                           TDisplacementImage>::BeforeThreadedGenerateData()
{
...
MultiResolutionThresholdBoundingBoxSearchRegionImageSource<
  ...
  TMovingImage,
  TMetricImage,
  TDisplacementImage>::ThreadedGenerateData(const OutputRegionType & outputRegion, ThreadIdType threadID)
{
  ...
  else
  {
    ...
    ImageRegionIteratorWithIndex<OutputImageType>         it(outputPtr, outputRegion);
    ImageRegionConstIterator<DisplacementImageType>       dispIt(m_DisplacementResampler->GetOutput(), outputRegion);
