#ifndef __itkBlockMatchingBlockAffineTransformMetricImageFilter_h
#define __itkBlockMatchingBlockAffineTransformMetricImageFilter_h
...
#include "itkBlockMatchingBlockAffineTransformMetricImageFilter.txx"
#endif
