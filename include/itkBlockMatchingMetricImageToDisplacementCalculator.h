#ifndef __itkBlockMatchingMetricImageToDisplacementCalculator_h
#define __itkBlockMatchingMetricImageToDisplacementCalculator_h
...
#include "itkBlockMatchingMetricImageToDisplacementCalculator.txx"
#endif
